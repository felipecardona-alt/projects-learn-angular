...
export class RegisterPage {
  ...
  myForm = this.formBuilder.group({
    ...
    email: ['', [Validators.required, Validators.pattern(ValidatorPatternsUtils.emailPattern)]],
    username: ['', [Validators.required, Validators.minLength(8), Validators.pattern(ValidatorPatternsUtils.notOnlySpacesPattern)]],
